<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\www\Test\public/../application/index\view\index\index.html";i:1520585964;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="container">
    <div class="row" style="margin-top: 60px">
        <div class="col-md-6 center-block">
            <button class="btn btn-default" id="picker">选择文件</button>
...
<script>
    var static = '/static';
    var url = '<?php echo url('index/index/upload'); ?>';
